...
function podeEntrarNaAuto(idade){
    if(idade>=18){
        return `Idade: ${idade}. Pode se matricular na auto escola`;
    } else {
        return `Idade: ${idade}. Não pode se matricular na auto escola`;
    }
}

console.log(podeEntrarNaAuto(16));
console.log(podeEntrarNaAuto(25));
console.log(podeEntrarNaAuto(17));
console.log(podeEntrarNaAuto(18));